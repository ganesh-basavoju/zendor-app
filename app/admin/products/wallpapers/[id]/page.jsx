    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <form onSubmit={handleSubmit} className="p-4 md:p-6 max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-xl md:text-2xl font-semibold text-[#003f62]">Edit Wallpaper Item</h1>
            <div className="text-sm text-gray-500 mt-1">
              Home <span className="mx-1">&gt;</span> Wallpapers <span className="mx-1">&gt;</span> Edit
            </div>
          </div>
        </div>
